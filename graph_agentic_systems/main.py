...
"""
This example demonstrates how to create a multi-agent system using a directed acyclic graph (DAG) structure.
Specialized agents are created for different tasks, and their interactions are defined through the graph.
